...
with open('AI_quick_draw.pickle', 'wb') as save_ai_quick_draw:
    pickle.dump(data_train/255., save_ai_quick_draw, protocol=pickle.HIGHEST_PROTOCOL)
    pickle.dump(label_train, save_ai_quick_draw, protocol=pickle.HIGHEST_PROTOCOL)
    pickle.dump(data_test/255., save_ai_quick_draw, protocol=pickle.HIGHEST_PROTOCOL)
